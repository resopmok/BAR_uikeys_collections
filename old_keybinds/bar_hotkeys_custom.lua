...
--		{ "Any+alt" , "mobile_waypoint_modifier" },
		...
		{       "sc_b,sc_b", "onoff", "0"           }, --added double tap for state, does not work with high trajectory
		{            "sc_b", "onoff", "1"           },
		{      "Shift+sc_b", "onoff"           },
		{       "Ctrl+sc_b", "selfd"           },
		...
		{            "sc_k", "wantcloak"       },
		{        "Any+sc_k", "wantcloak"       },
		{       "sc_l,sc_l", "firestate", "2"  }, --added double tap for state
		{            "sc_l", "firestate", "0"  },
		{      "Shift+sc_l", "firestate"       },
		{       "sc_;,sc_;", "movestate", "1"  }, --added double tap for state
		{            "sc_;", "movestate", "0"  }, 
		{      "Shift+sc_;", "movestate"       },
		{            "sc_m", "restore"         },
		{      "Shift+sc_m", "restore"         },
		{            "sc_n", "gatherwait"      }, --added for testing
		{      "Shift+sc_n", "gatherwait"      }, --added for testing
		...
		{       "sc_t,sc_t", "repeat", "0"     }, --added double tap for state
		{            "sc_t", "repeat", "1"     },
		{      "Shift+sc_t", "repeat"          },
--		{       "sc_u,sc_u", "loadunits"       }, --double tap for load
--		{ "Shift+sc_u,sc_u", "loadunits"       },
		{            "sc_u", "unloadunits"     },
...
--		{ "Ctrl+sc_w",    "select", "AllMap+_InPrevSel+_ClearSelection_SelectAll+"                                                                             },
        { "Ctrl+sc_w",    "select", "Visible+_Waiting+_ClearSelection_SelectAll+"                                                                              },
		{ "Ctrl+sc_t",    "select", "AllMap+_Transport_Idle+_ClearSelection_SelectAll+"                                                                        },
		-- numpad movement
		{ "numpad2", "moveback"    },
		{ "numpad6", "moveright"   },
		{ "numpad4", "moveleft"    },
