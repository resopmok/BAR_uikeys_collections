-- Based on grid optimized keys captured 30/4/23
-- Swaps all functions of zxcv and qwer and inverts hotkeys for grid menu unit selections (e.g., zx for a solar becomes qw)	
	local bindings = {
		...
		{           "sc_q", "gridmenu_category 1" },
		{           "sc_w", "gridmenu_category 2" },
		{           "sc_e", "gridmenu_category 3" },
		{           "sc_r", "gridmenu_category 4" },
		{     "Shift+sc_q", "gridmenu_category 1" },
		{     "Shift+sc_w", "gridmenu_category 2" },
		{     "Shift+sc_e", "gridmenu_category 3" },
		{     "Shift+sc_r", "gridmenu_category 4" },
		{       "Any+sc_q", "gridmenu_key 1 1"    },
		{       "Any+sc_w", "gridmenu_key 1 2"    },
		{       "Any+sc_e", "gridmenu_key 1 3"    },
		{       "Any+sc_r", "gridmenu_key 1 4"    },
		{       "Any+sc_a", "gridmenu_key 2 1"    },
		{       "Any+sc_s", "gridmenu_key 2 2"    },
		{       "Any+sc_d", "gridmenu_key 2 3"    },
		{       "Any+sc_f", "gridmenu_key 2 4"    },
		{       "Any+sc_z", "gridmenu_key 3 1"    },
		{       "Any+sc_x", "gridmenu_key 3 2"    },
		{       "Any+sc_c", "gridmenu_key 3 3"    },
		{       "Any+sc_v", "gridmenu_key 3 4"    },
		...
		{ "Ctrl+sc_c",    "select", "AllMap++_ClearSelection_SelectAll+"                                                                                       },
		...
		{      'sc_z',    "select", "Visible+_InPrevSel+_ClearSelection_SelectAll+"                                                                            },
		{ "Ctrl+sc_z",    "select", "PrevSelection++_ClearSelection_SelectPart_50+"                                                                            },		
